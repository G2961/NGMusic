...
class Track {
  ...
  /// Мой голос на этом треке в шкале NG 0..10 (из votebar-а страницы:
  /// сервер рендерит checked-радио только при существующем голосе).
  /// null — не голосовал или не определён.
  int? myVote;
